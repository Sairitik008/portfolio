🌐 Sairitik Naidu — Portfolio Website

This repository contains the source code for my personal portfolio website.
The website showcases my professional background, technical skills, projects, and resume in a clean and structured format.

It is designed to be simple, responsive, and easy to customize, making it suitable both as a personal website and as a base template for other developers.
...
git clone https://github.com/Sairitik008/Portfolio.git
...
It helps and is always appreciated!
